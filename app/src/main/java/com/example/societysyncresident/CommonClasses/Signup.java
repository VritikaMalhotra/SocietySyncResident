...
public class Signup extends AppCompatActivity{
    ...
    private EditText editTextFullName,editTextEmail,editTextMobileNumber,editTextFlatNumber,editTextBlockNumber,editTextSocietyId;
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    DatabaseReference databaseReferenceSocietyId = FirebaseDatabase.getInstance().getReference().child("resident_session").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                    databaseReferenceSocietyId.child("society_id").setValue(societyId);
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("societies").child(societyId).child("resident_registration").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
